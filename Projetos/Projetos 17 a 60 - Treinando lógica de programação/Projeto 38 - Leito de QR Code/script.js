    ...
    leitor.onload = function (evento) {
        ...
        img.onload = function () {
            ...
            if (codigo){
                ...
                document.getElementById('resultado').innerHTML = `QR Code lido: ${codigo.data}`;

            } else{

                document.getElementById('resultado').innerHTML = `Não foi possível ler o QR Code. Tente novamente.`;
